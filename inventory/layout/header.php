<div class="header container-content">
    <div class="heading">
        ...
        <span class="uppercase">Quản lí kho</span>
    </div>
    <div class="content-header">
        <div
            class="icon-hover has-drop-down-menu mail-menu"
            onclick="showDropDownMenu(this)">
            <i class="fa-regular fa-envelope"></i>
            <div class="drop-down-menu">
                <div class="mail">
                    <span>Không có thư nào</span>
                </div>
            </div>
        </div>
        <div
            class="icon-hover has-drop-down-menu notification-menu"
            onclick="showDropDownMenu(this)">
        ...
        <div
            class="icon-hover has-drop-down-menu username-menu"
            onclick="showDropDownMenu(this)">
